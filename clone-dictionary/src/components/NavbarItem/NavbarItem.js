            ...
            <ul className="space-y-2">
                ...
                <li>
                    <button type="button" className="flex items-center w-full p-2 text-base font-normal transition duration-75 rounded-lg group " aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Gaming</span>
                    ...
                    <ul id="dropdown-example" className="hidden py-2 space-y-2">
                        <li>
                            <a href="#" className="flex w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group ">Dropdown</a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center w-full p-2 text-base font-normal transition duration-75 rounded-lg pl-11 group ">Dropdown</a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group">Dropdown</a>
                        </li>
                ...
                <li>
                    <a href="#" className="flex items-center p-2 text-base font-normal">
                    <span className="ml-3">Television</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex items-center p-2 text-base font-normal">
